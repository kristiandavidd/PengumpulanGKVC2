...
void initRendering() {
    ...
    Image* image = loadBMP("k1.bmp");
    _textureId = loadTexture(image);

    Image* image1 = loadBMP("k2.bmp");
    _textureId1 = loadTexture(image1);

    Image* image2 = loadBMP("k3.bmp");
    _textureId2 = loadTexture(image2);

    Image* image3 = loadBMP("k4.bmp");
    _textureId3 = loadTexture(image3);

    Image* image4 = loadBMP("k5.bmp");
    _textureId4 = loadTexture(image4);

    Image* image5 = loadBMP("k6.bmp");
